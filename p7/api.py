...
from p7.test_prepare_download_google_drive_files.api import (
    fetch_test_prepare_download_google_drive_files_router
)
...
api.add_router("/fetch_test_prepare_download_google_drive_files/",
               fetch_test_prepare_download_google_drive_files_router)
